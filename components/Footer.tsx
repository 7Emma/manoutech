        ...
        <div className="ft-main">
          ...
          <div>
            <a href="/" className="ft-brand-logo">
              <Image src={logo} alt="Manoutech" className="h-9 w-auto" />
            </a>
            ...
            <div className="ft-badges">
              {badges.map((b) => (
                <span key={b} className="ft-badge" title={b}>
                  <TechIcon name={b} />
                </span>
              ))}
            </div>
