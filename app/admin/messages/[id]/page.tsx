...
export default function MessageDetailPage({
  ...
  useEffect(() => {
    (async () => {
      const { data: msg } = await messagesService.get(params.id);
      setMessage(msg);
      setLoading(false);
    })();
  }, [params.id]);
  ...
  const handleDelete = async () => {
    ...
    try {
      await messagesService.remove(params.id);
  ...
  return (
    <>
      ...
      <div className="md-root">
        <div className="md-inner">
          <a href="/admin/messages" className="md-back-btn">
            ← Retour aux messages
          </a>
          ...
          <div className="md-layout">
            <div className="md-card">
              <div className="md-sender">
                ...
                <div className="md-sender-right">
                  <div className="md-sender-date">
                    {fmt(message.created_at).split(" ")[0]}
                  </div>
              ...
              <div className="md-msg-body">
                ...
                <div className="md-actions">
                  {!message.read && (
                    <button className="md-action-btn" onClick={handleMarkRead}>
                      {Icons.check} Marquer comme lu
                    </button>
                  )}
                  <button
                    className="md-action-btn danger"
            ...
            <div>
              <div className="md-sidebar-card">
                ...
                <div
                  className="md-sidebar-badge"
                  style={{
                    background: message.read ? "#f0f0f0" : "rgba(36,38,117,.1)",
                    color: message.read ? "#7A7F84" : "#242675",
                  }}
                >
